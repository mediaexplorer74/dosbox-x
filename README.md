...
## About my project
Now this is only "dirty fork" of sdl2-branch of [DOSBOX-X Win32](https://github.com/joncampbell123/dosbox-x/).

At stage 1 I'll try to stabalize the Win32 (x64) build (SDL/SDL2 components, etc.) Maybe soon :) (c) Sandra - Maybe Tonight

At stage 2 I'll plan to do some UWP porting. Ideally to downgrade min os build to 14xxx :) Now it is 17xxx, heh!
...
- [joncampbell123](https://github.com/joncampbell123) - Great C++ developer, DosBox-X "bombardier" :)
- [DosBox-X](https://github.com/joncampbell123/dosbox-x/) - Original DosBox-X


## License & Copyright

DosBox-X is RnD project only. AS-IS. No support. Distributed under the MIT License.  
